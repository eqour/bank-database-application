...
<form class="form" method="POST">
    <div class="mb-3">
        ...
        <input class="form-control <?= FormHelper::invalidClass($form, 'passport') ?>" value="<?= $form->getField('passport') ?>" type="text" name="CustomerSearchForm[passport]" maxlength="10" autofocus>
